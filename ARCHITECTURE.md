    ...
    └──────────────────┘   │  + Cloudflare)       │
           ...
           └──────────────────┘            │
                            ...
                            SUCCESS                 FAIL
                                ...
                                ▼                     ▼
                     ┌──────────────────┐   ┌──────────────────────┐
                     │ Cache Response   │   │ Try Provider 3:      │
                     │ Return to Client │   │ Cloudflare Workers 🟠│
                     │ ✅               │   └────────┬─────────────┘
                     └──────────────────┘            │
                                          ┌──────────┴──────────┐
                                          │                     │
...
### 2️⃣ OpenRouter (Secondary)
- **Model:** meta-llama/llama-3.2-3b-instruct:free
- **Free Tier:** Rate-limited
- **Latency:** ~2-4 seconds
- **Use Case:** Backup when Gemini fails or is rate-limited

### 3️⃣ Cloudflare Workers AI (Tertiary - Optional)
- **Model:** @cf/meta/llama-2-7b-chat-fp16
- **Free Tier:** 10,000 requests/day
- **Latency:** ~2-3 seconds
- **Use Case:** Additional backup for high-traffic or maximum reliability
